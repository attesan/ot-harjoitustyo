class ProjectPoint:
    ...
    def __init__(self, parent_device_position:str, point_position:str, point_type:str, point_name_separator:str = "_"):
    ...
    def __compose_point_name(self):
        return self.__device_position + self.__separator + self.point_position + self.__separator + self.point_type
